...
load_epiextracts, begin(2018m1) end(2018m12) sample(basic) version(local) keep(`analysisvarlist' `othervars')
tempfile fulldata
save `fulldata'
...
local analysisvarlist veteran multjob ptecon selfemp selfinc pubsec pubst pubfed publoc nilf lfstat unemp schenrl emp wbho wbhao wbo_only wbho_only age educ
...
tempfile maydata
save `maydata'
load_epiextracts, begin(1976m1) end(2018m12) sample(basic) version(local) keep(`analysisvarlist' `othervars')
...
load_epiextracts, begin(1979m1) end(2018m12) sample(org) version(local) keep(`analysisvarlist' `othervars')
tempfile orgdata
save `orgdata'
...
load_epiextracts, begin(1983m1) end(2018m12) sample(org) version(local) keep(`analysisvarlist' `othervars')
tempfile orgdata
save `orgdata'
