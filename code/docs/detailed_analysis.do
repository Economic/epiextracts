...
load_epiextracts, begin(2019m1) end(2019m12) sample(basic) version(local) keep(`analysisvarlist' `othervars')
tempfile fulldata
save `fulldata'
...
tempfile maydata
save `maydata'
load_epiextracts, begin(1976m1) end(2019m12) sample(basic) version(local) keep(`analysisvarlist' `othervars')
...
load_epiextracts, begin(1979m1) end(2019m12) sample(org) version(local) keep(`analysisvarlist' `othervars')
tempfile orgdata
save `orgdata'
...
load_epiextracts, begin(1983m1) end(2019m12) sample(org) version(local) keep(`analysisvarlist' `othervars')
tempfile orgdata
save `orgdata'
