...
title("Share of hourly earners receiving overtime/tips/commissions, 1994-2017", size(medium)) ///
...
/***
The analysis above uses hourly wage earners, ages 16-64,from the CPS ORG for 1994-2017.
***/
