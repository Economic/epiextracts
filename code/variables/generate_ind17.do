...
if $monthlycps == 1 | $marchcps == 1 {
	if tm(2020m1) <= $date & $date <= tm(2024m12) {
...
3790 "Prefabricated wood building and mobile homes"
3875 "Miscellaneous wood products"
...
notes ind17: Industry classification for 2020-2024
notes ind17: 2020-2024 CPS: peio1icd
