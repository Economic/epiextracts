...
if $marchcps == 1 {
	...
	if tm(1995m1) <= $date & $date <= tm(1997m12) {
		replace higotherly = 1 if champ == 1 /* military/veteran health insurance */
		replace higotherly = 1 if hiihsly == 1 /* Indian health services */
	...
	if tm(2019m1) <= $date {
		replace higotherly = 1 if ihsflg == 1 /* Indian health services */
...
notes higotherly: Available 1980-present
notes higotherly: 1980-present universe: All persons (not infants born after calendar year)
notes higotherly: 1980-1994 Unicon: champ
notes higotherly: 1995-1997 Unicon: oth, othstper
notes higotherly: 1998-2000 CPS: champ, otyp_4, othstyp1-6
notes higotherly: 2001-2018 CPS: champ, ihsflg
