...
note pttlwk: U PRTAGE = 16+ AND PEMLR = 1
note pttlwkhr: U PTTLWK = 1
...
label define pehravl
	...
	2           "NO"
;
label values pttlwk pttlwk;
label define pttlwk
	1 			"YES"
	2			"NO"
;
label values pttlwkhr pttlwkhr;
label define pttlwkhr
	0 			"MIN VALUE (Less than 30 minutes)"
	97			"MAX VALUE"
;
