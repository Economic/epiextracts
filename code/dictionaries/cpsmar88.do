capture log close
log using cpsmar88.log, replace
set mem 500m
...
local dat_name "/homes/data/cps/cpsmar88.dat"

/* The following line should contain the path to your output '.dta' file */

local dta_name "./cpsmar88.dta"

/* The following line should contain the path to the data dictionary file */

local dct_name "./cpsmar88.dct"
...
note h_telint: U H HHTYPE = 1
note hg_reg: U H TELAVL = 1
note hg_st60: U All households
note hg_strn: U All households
note hg_msac: U All households
note hg_pmsa: U All households
note hg_msar: U All households
note hg_cmsa: U All households
note hmssz: U All households
note hpmsasz: U All households
note hmsa_r: U All households
note hccc_r: U All households
note hfarm: U All households
note hunder15: U All households
note hcmcare: U H-HHTYPE = 1
...
note hpctcut: U H-TYPE = 1-8
note indccode: U H-TYPE = 1-8
note hsup_wgt: U All households
note hptenure: U H-HHTYPE = 1
note frecord: U H-HHTYPE = 1,2,3
...
note fownu18: U All families
note frelu6: U All families
note frelu18: U All families
note fpctcut: U All families
note fpovcut: U All families
note famlis: U All families
note povll: U All families
note frspov: U All families
note frsppct: U F-TYPE = 3
note finc_ws: U F-TYPE = 3
note fwsval: U FOMC-WS = 1
note finc_se: U All families
...
note ftot_r: U All families
note fspanish: U All families
note fsup_wgt: U All families
note ffposold: U All families
note precord: U All families
note ph_seq: U All persons
note pppos: U All persons
note a_lineno: U All persons
note a_parent: U All persons
note a_exprrp: U All persons
note a_age: U All persons
note a_maritl: U All persons
note a_spouse: U A-AGE greater than or equal to 15
note a_sex: U A-AGE greater than or equal to 15
note a_vet: U All persons
note a_hga: U All persons
note a_hgc: U All persons
note a_race: U All persons
note p_stat: U All persons
note a_reorgn: U All persons
note a_famnum: U All persons
note a_famtyp: U All persons
note a_famrel: U All persons
note a_pfrel: U All persons
note hhdrel: U All persons
note famrel: U All persons
note hhdfmx: U All persons
note parent: U All persons
note age1: U A-AGE less than or equal to 17
note schl1: U A-AGE greater than or equal to 15
note phf_seq: U A-AGE greater than or equal to 15
note pf_seq: U All persons
note prnt_ptr: U All persons
note a_fnlwgt: U A-PARENT greater than or equal to 1
note a_ernlwt: U All persons
note marsupwt: U H-MIS = 4 or 8
note a_ajact: U All persons
note a_anywk: U All persons
note a_hrs1: U A-MAJAC (I-19) = 2,3,4,5,7,8 (ne 1,6)
note a_hrschk: U A-MAJAC (I-19) = 1 or  A-ANYWK (I-20) = 1
note a_uslft: U Same as A-HRS1 (I-20A)
note a_ftreas: U A-HRSCHK (I-20B) = 2
note a_lostim: U A-HRSCHK (I-20B) = 2
note a_ovrtim: U A-HRSCHK (I-20B) = 3
note a_jobabs: U A-HRSCHK = 3
note a_whyabs: U A-ANYWK (I-20) = 2
note a_payabs: U A-JOBABS (I-21) = 1
note a_ftabs: U A-WHYABS (I-21A) = 1-4, 8
note a_lkwk: U A-WHYABS (I-21A) = 1-4, 8
note a_mthd1: U A-JOBAB (I-21) = 2
note a_wkslk: U A-LKWK (i-22) = 1 and A-MATHD6 (ne 1)
note a_lkftpt: U A-WHYLK (I-22B) = entry or
note a_avail: U Same as A-WKSLK (I-22C)
note a_whyna: U Same as A-WKSLK (I-22C)
note a_whenlj: U A-AVAIL (I-22E1) = 2
note a_ind: U Same as A-WKSLK (I-22C)
note a_occ: U A-CLSWKR = 1-7
note a_clswkr: U A-CLSWKR = 1-7
note ppposold: U A-LFSR = 1-4 or A-LFSR = 5-7;
note a_nlflj: U All persons
note a_whylft: U H-MIS = 4 OR 8 and (A-LKWK = 2 or
note a_wantjb: U A-NLFLJ (I-24) = 1-5
note a_whynl1: U A-NLFLJ = 1-7
note a_uslhrs: U A-NLFLJ = 1-7
note a_hrlywk: U A-ERNEL = 1
note a_hrspay: U A-ERNEL = 1
note a_grswk: U A-HRLYWK (I-25B) = 1
note a_unmem: U A-ERNEL = 1
note a_uncov: U A-ERNEL = 1
note a_enrchk: U A-UNMEM (I-25E) = 2
note a_enrlw: U All persons
note a_hscol: U A-ENRCHK (I-26) = 1
note a_ftpt: U A-ENRCHK (I-26A1) = 1
note a_lfsr: U A-ENRCHK (I-26A1) = 1
note a_untype: U All persons
note a_nlfrea: U A-LFSR = 3 or 4
note a_wkstat: U LFSR = 5, 6 or 7 and MIS = 4 or 8
note a_explf: U All persons
note a_wksch: U A-CLSWKR NE 8
note a_civlf: U A-LFSR = 1-4
note a_ftlf: U A-LFSR = 1-4
note a_mjind: U A-WKSTAT = 2,3,6
note a_dtind: U A-CLSWKR = 1-7
note a_mjocc: U A-CLSWKR = 1-7
note a_dtocc: U A-CLSWKR = 1-7
note a_ernel: U A-CLSWKR = 1-7
note a_rcow: U All persons
note workyn: U All families
note wtemp: U All persons
note nwlook: U WORKYN = 2
note nwlkwk: U WTEMP = 2
note rsnnotw: U NWLOOK = 1
note wkswork: U WTEMP = 2
note wkcheck: U WORKYN = 1 or WTEMP =1
note losewks: U WORKYN = 1 or WTEMP = 1
note lknone: U WKSWORK = 50, 51
note lkweeks: U WKSWORK = 1-49
note lkstrch: U WKSWORK = 1-49
note pyrsn: U Entry in LKWEEKS
note phmemprs: U WKSWORK = 1-49 and sum of entries in
note hrswk: U WKSWORK = 1 or WTEMP = 1
note hrcheck: U WORKYN = 1 or WTEMP = 1
note ptyn: U WORKYN = 1 or WTEMP = 1
note ptweeks: U HRCHECK = 2
note ptrsn: U PTYN = 1 or HRCHECK = 1
note ljcw: U PTYN = 1 or HRCHECK = 1
note industry: U WORKYN = 1 or WTEMP = 1 or current Armed
note occup: U WORKYN = 1 or WTEMP = 1 or current Armed
note wexp: U WORKYN = 1 or WTEMP = 1 or current
note wewkrs: U P-STAT = 1
note welknw: U P-STAT = 1
note weuemp: U P-STAT = 1
note earner: U P-STAT = 1
note clwk: U A-AGE greater than or equal to 15
note weclw: U WORKYN = 1 or WTEMP = 1 or current
note poccu2: U WORKYN = 1 or WTEMP = 1 or current
note wemocg: U WORKYN = 1 or WTEMP = 1 or current
note weind: U WORKYN = 1 or WTEMP = 1 or current
note wemind: U WORKYN = 1 or WTEMP = 1 or current
note migsame: U WORKYN = 1 or WTEMP = 1 or current
note grin_reg: U A-AGE greater than or equal to 1
note grin_st: U MIGSAME = 2
note mig_mtr1: U MIGSAME = 2
note mig_mtr3: U A-AGE greater than or equal to 1
note mig_mtr4: U Persons 1+
note migsun: U A-AGE greater than or equal to 1
note grn_plac: U All persons
note placdscp: U MIGSAME = 2
note noemp: U MIGSAME = 2
note ern_yn: U WORKYN = 1 or WTEMP = 1 or current
note ern_val: U WORKYN = 1 or WTEMP =1 or current
note ern_srce: U ERN-YN = 1
note ern_otr: U ERN-YN = 1
note wageotr: U WORKYN = 1 or WTEMP = 1 or current
note ws_val: U ERN-OTR = 1
note wsal_yn: U WAGEOTR =1
note wsal_val: U ERN-SRCE = 1 or WAGEOTR = 1
note seotr: U WSAL-YN = 1
note se_val: U ERN-OTR = 1
note semp_yn: U SEOTR = 1
note semp_val: U ERN-YN = 2 or SEOTR = 1
note frmotr: U ERN-YN =1 or SEOTR = 1
note frm_val: U ERN-OTR = 1
note frse_yn: U FRMOTR =1
note frse_val: U ERN-SRCE = 3 or FRMOTR = 1
note uc_yn: U FRSE-YN = 1
note subuc: U Age greater than or equal to 15
note strkuc: U UC-YN = 1
note uc_val: U UC-YN = 1
note wc_yn: U UC-YN = 1
note wc_type: U AGE greater than or equal to 15
note wc_val: U WC-YN = 1
note ss_yn: U WC-YN = 1
note ss_val: U HSS-YN = 1
note ssi_yn: U SS-YN = 1
note ssi_val: U HSSI-YN = 1
note paw_yn: U SSI-YN = 1
note paw_typ: U HPAW-YN = 1
note paw_mon: U PAW-YN = 1
note paw_val: U PAW-YN = 1
note vet_yn: U PAW-YN = 1
note vet_typ1: U HVET-YN = 1
...
note sur_sc1: U HSUR-YN = 1
note sur_sc2: U SUR-YN = 1
note sur_val1: U SUR-SC1 = 1:10
note sur_val2: U SUR-YN = 1, SUR-SC1 = 1:10
note srvs_val: U SUR-SC2 = 1:10
note dis_hp: U SUR-YN = 1
note dis_cs: U HDIS-YN = 1
note dis_sc1: U HDIS-YN = 1
note dis_sc2: U DIS-YN = 1
note dis_val1: U DIS-YN = 1 and 2 entries
note dis_val2: U DIS-YN = 1
note dsab_val: U DIS-YN = 1
note ret_yn: U DIS-YN = 1
note ret_sc1: U HRET-YN = 1
note ret_sc2: U RET-YN = 1
note ret_val1: U RET-YN = 1 and 2 entries in
note ret_val2: U RET-YN = 1
note rtm_val: U RET-YN = 1
note int_yn: U RET-YN = 1
note int_val: U HINT-YN = 1
note div_yn: U INT-YN = 1
note div_non: U HDIV-YN = 1
note div_val: U DIV-YN = 1
note rnt_yn: U DIV-YN = 1
note rnt_val: U HRNT-YN = 1
note ed_yn: U RNT-YN = 1
note oed_typ1: U HED-YN = 1
note oed_typ2: U ED-YN = 1
note oed_typ3: U ED-YN = 1
note ed_val: U ED-YN = 1
note csp_yn: U ED-YN = 1
note csp_val: U HCSP-YN = 1
note alm_yn: U CSP-YN = 1
note alm_val: U HALM-YN = 1
note fin_yn: U ALM-YN = 1
note fin_val: U HFIN-YN = 1
note oi_off: U FIN-YN = 1
note oi_yn: U OI-YN = 1
note oi_val: U HOI-YN = 1
note ptotval: U OI-YN = 1
note pearnval: U A-AGE greater than or equal to 15
note pothval: U A-AGE greater than or equal to 15
note ptot_r: U A-AGE greater than or equal to 15
note perlis: U A-AGE greater than or equal to 15
...
note hielse1: U HIEMP = 1
note hielse2: U HIOWN = 1
note hielse3: U HIOWN = 1
note hielse4: U HIOWN = 1
note hielse5: U HIOWN = 1
note wrk_ck: U HIOWN = 1
note penplan: U WORKYN = 1 or WTEMP = 1
note penincl: U WRK-CK = 1
note cov_gh: U PENPLAN = 1
note cov_hi: U All persons
note ch_mc: U All persons
note ch_hi: U A-AGE Less than 15
note aplineno: U A-AGE Less than 15
...
label define hhstatus
	...
	1           "Primary family"                
	2           "Primary individual living alone"
	3           "Primary individual living with"
;
...
;
label values a_ajact  a_ajact;
label define a_ajact 
	0           "Children or Armed Forces"      
	1           "Working"                       
...
label define sur_vala
	0           "None or not in universe"       
	99999       "Survivor's income - source 1"  
;
