...
vars <- c(
  ...
  "METRO", "PUBHOUS", "RENTSUB", "FAMINC", 
  "CPSIDP", "CPSIDV",  "AGE", "SEX", "RACE", 
  "MARST", "VETSTAT", "NCHILD", 
  "FTYPE", "FAMKIND", "FAMREL", "CITIZEN", "HISPAN", "EMPSTAT", 
  "LABFORCE", "CLASSWKR", "DURUNEMP", "WHYUNEMP", "WHYABSNT", 
  "WKSTAT", "EDUC", "HIGRADE", "SCHLCOLL", "ROTATE",  
  "ASECFWT", "OCCLY", "INDLY", "CLASSWLY", "UHRSWORKLY", "WKSUNEM1", 
  "NWLOOKWK", "PENSION", "FTOTVAL", "INCTOT", "INCWAGE", "CTCCRD", 
  "ACTCCRD", "EITCRED", "OFFPOV", "OFFPOVUNIV", "OFFTOTVAL", "OFFCUTOFF", 
  "POVERTY", "CUTOFF", "FOODSTMP", "SCHLLUNCH", "SPMLUNCH", "SPMNEWFAM", 
  "SPMPOV", "SPMMORT", "SPMWT", "SPMSTTAX", "SPMFEDTAXAC", "SPMEITC", 
  "SPMWIC", "SPMSNAP", "SPMTHRESH", "MIGRATE1", "INCLUGH", 
  "PAIDGH", "HIMCAIDLY", "CAIDLY", "CAIDNW", "ANYCOVLY", "ANYCOVNW", 
  "PAIDHOUR", "UNION", 
